...
/* $Id: en.lang.php 5694 2011-11-16 16:02:57Z gaika $ */
...
define("NETCAT_MODULE_AUTH_NOT_NEW_MESSAGE", "Not new message");
...
define("NETCAT_MODULE_AUTH_ADMIN_CLASSIC_AUTH_CAPTCHA_NUM", "Show CAPTCHA after %input authorization attempts ( 0 - don&#039;t show)");
...
define("NETCAT_MODULE_AUTH_ADMIN_SYSTEM_OTHER_ONLINE", "Time user is considered online, in seconds");
define("NETCAT_MODULE_AUTH_ADMIN_SYSTEM_OTHER_IP", "Level IP-address check (0-4)");
...
define("NETCAT_MODULE_AUTH_OPEN_ID_AUTH_COMPLETE_NAME", "Auth succesfull as <a href='%s'>%s</a> ");
