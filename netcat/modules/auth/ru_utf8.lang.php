...
/* $Id: ru_utf8.lang.php 5694 2011-11-16 16:02:57Z gaika $ */
...
define("NETCAT_MODULE_AUTH_ADMIN_CLASSIC_AUTH_CAPTCHA_NUM", "Показывать CAPTCHA после %input попыток авторизации ( 0 - не показывать)");
