...
<div class="nc-modal-dialog">
    <div class="nc-modal-dialog-header">
        ...
        <div class="nc-modal-dialog-header-tabs"></div>
    </div>
...
<!--            <i class="nc-icon-l nc--status-info"></i>-->
    ...
    <div class="nc-modal-dialog-footer">
        <div class="nc--left nc-netshop-variant-multiple-count">
        ...
        <button class="nc-btn nc--red nc--bordered" data-role="close"><?= CONTROL_BUTTON_CANCEL ?></button>
    </div>
</div>
