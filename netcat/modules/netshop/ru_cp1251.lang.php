...
define("NECTAT_MODULE_NETSHOP_PURCHASED_GOODS",              "Куплено товаров");
...
define("NETCAT_MODULE_NETSHOP_GROUP_BY", "Группировать");
define("NETCAT_MODULE_NETSHOP_BY_DAYS", "По дням");
define("NETCAT_MODULE_NETSHOP_BY_WEEKS", "По неделям");
define("NETCAT_MODULE_NETSHOP_BY_MONTHS", "По месяцам");
...
define("NETCAT_MODULE_NETSHOP_1C_INTEGRATION", "Интеграция с 1С");
...
define("NETCAT_MODULE_NETSHOP_DELIVERY_TYPE_DONT_USE", "Не использовать");
define("NETCAT_MODULE_NETSHOP_DELIVERY_TYPE_FIELD_MAPPING", "Соответствие полей для типа доставки «%s»");
define("NETCAT_MODULE_NETSHOP_DELIVERY_TYPE_FIELD_MAPPING_SHOP", "Настройки магазина");
define("NETCAT_MODULE_NETSHOP_DELIVERY_TYPE_FIELD_MAPPING_ORDER", "Параметры заказа");
...
//Filter
define("NETCAT_MODULE_MINISHOP_FILTER_SHOW",  "Показать");
define("NETCAT_MODULE_MINISHOP_FILTER_RESET", "Сбросить фильтр");
define("NETCAT_MODULE_MINISHOP_FILTER_FROM",  "от");
define("NETCAT_MODULE_MINISHOP_FILTER_TO",    "до");
...
define("NETCAT_MODULE_NETSHOP_IMPORT_AUTO_RENAME_SUBDIVISIONS", "Переименовывать разделы, если изменены группы в 1С");
...
define("NETCAT_MODULE_NETSHOP_IMPORT_MAP_CHARACTERISTICS", "Укажите соответствие харатеристик вариантов товара полям компонента");
...
define("NETCAT_MODULE_NETSHOP_ORDER_SEARCH", "Поиск по номеру заказа, имени клиента, телефону, адресу электронной почты");
...
define("NETCAT_MODULE_NETSHOP_SOURCES_NO_SOURCES_MESSAGE", 'На этой странице отображаются созданные источники обмена данными с 1С.<br>Для создания нового источника перейдите в раздел: ');
...
define("NETCAT_MODULE_NETSHOP_SOURCES_1C_ID", "Идентификатор 1C");
...
define("NETCAT_MODULE_NETSHOP_ORDER_STATUS", "Статус заказов");
...
define("NETCAT_MODULE_NETSHOP_ITEM_VARIANTS_PRICE_RANGE", "от %s до %s");
...
define("NETCAT_MODULE_NETSHOP_1C_EXPORT_ORDERS_STATUS", "Статусы заказов для экспорта в 1С");
...
define("NETCAT_MODULE_NETSHOP_MAILER_TEMPLATE_ORDER_TOTAL_CART_DISCOUNT", "Сумма скидки на корзину");
...
define("NETCAT_MODULE_NETSHOP_MAILER_TEMPLATE_ORDER_DELIVERY_PRICE", "Стоимость доставки");
...
define('NETCAT_MODULE_NETSHOP_COND_CART_SUM', 'стоимость товаров');
...
define('NETCAT_MODULE_NETSHOP_CONDITION_TYPE_CART_SUM', 'Общая стоимость товаров (без учёта скидок)');
...
define("NETCAT_MODULE_NETSHOP_PROMOTION_DISCOUNTS", "Скидки");
...
define('NETCAT_MODULE_NETSHOP_PROMOTION_DISCOUNT_REQUIRES_COUPON_CODE', 'Для активации скидки необходим купон');
define('NETCAT_MODULE_NETSHOP_PROMOTION_DISCOUNT_CREATE_COUPONS_AFTER_SAVING', 'Создать купоны после сохранения скидки');
define('NETCAT_MODULE_NETSHOP_PROMOTION_DISCOUNT_NUMBER_OF_COUPONS', 'Купонов: %s (в т.ч. действительных: %s)');
...
define('NETCAT_MODULE_NETSHOP_1C_SECRET_NAME', '1С Secret Name');
define('NETCAT_MODULE_NETSHOP_1C_SECRET_KEY', '1С Secret Key');
...
define("NETCAT_MODULE_NETSHOP_YANDEX_MARKET_NO_BUNDLES", "Связки для экспорта в Яндекс.Маркет на выбранном сайте отсутствуют");
