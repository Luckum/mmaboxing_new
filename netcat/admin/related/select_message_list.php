...
<html>
    <head>
        ...
        <link type='text/css' rel='Stylesheet' href='<?=$ADMIN_TEMPLATE
?>css/admin.css'>
        <link type='text/css' rel='Stylesheet' href='<?=$ADMIN_TEMPLATE
?>css/main.css'>
    </head>
    ...
    <body style='margin:0; overflow: hidden'>
        ...
        if (!$cc_list) {
            ...
            print "<iframe src='".$SUB_FOLDER.$HTTP_ROOT_PATH."?sub=$sub&cc=$cc&inside_admin=1&list_mode=select' width='100%' height='100%' frameborder='0'></iframe>\n";
