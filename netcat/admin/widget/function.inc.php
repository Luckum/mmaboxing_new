    ...
    if ($result) {
        ...
        foreach ($result as $key => $val) {
            if (md5($val['Category']) == $category || !isset($category)) {
                ...
                "<td><a class='nc-label nc--blue' href='".$ADMIN_PATH."field/index.php?fs=".get_fs()."&widgetclass_id=".$key."&fs=".get_fs()."'>".$val['Fields']." ".mb_strtolower( plural_form($val['Fields'], CONTROL_CLASS_FIELD, CONTROL_CLASS_FIELDS, CONTROL_CLASS_FIELDS_COUNT) )."</a></td>".
...
class ui_config_widgetclass extends ui_config {
    ...
    function ui_config_widgetclass($active_tab = 'edit', $class_id = 0, $class_group = '') {
...
class ui_config_widgetclasses extends ui_config {
    ...
    function ui_config_widgetclasses($active_tab = 'widgetclass.list', $category='') {
        $this->headerText = SECTION_CONTROL_WIDGETCLASS;
        ...
        $this->activeTab = $active_tab;
        $this->locationHash = ($category != "" ? "#widgetgroup" : "#widgetclass.list");
...
class ui_config_widgetes extends ui_config {
    ...
    function ui_config_widgetes($active_tab = 'widgets') {
...
class ui_config_widget extends ui_config {
    ...
    function ui_config_widget($active_tab = 'edit', $class_id = 0, $class_group = '') {
