...
class ui_config_subdivision_settings extends ui_config_subdivision_generic {
     ...
     * @param integer
     */
    function ui_config_subdivision_settings($sub_id, $toolbar_action = 'edit') {
        ...
        // кнопки на тулбаре
        $this->toolbar = array();
        foreach (array('edit', 'design', 'seo', 'system', 'fields') as $v) {
...
class ui_config_subdivision_add extends ui_config {
    ...
    function ui_config_subdivision_add($parent_sub_id, $catalogue_id=0) {
...
class ui_config_subdivision_delete extends ui_config {
    ...
    function ui_config_subdivision_delete($sub_id) {
...
class ui_config_subdivision_delete_service_subs extends ui_config_subdivision_delete {
    ...
    function ui_config_subdivision_delete_service_subs($sub_id) {
...
class ui_config_subdivision_info extends ui_config_subdivision_generic {
    ...
    function ui_config_subdivision_info($sub_id, $toolbar_action) {
        $this->init($sub_id, 0);
        $this->activeTab = "info";
...
class ui_config_subdivision_subclass extends ui_config_subdivision_generic {
    ...
    function ui_config_subdivision_subclass($sub_id, $toolbar_action, $cc_id=0) {
        $this->init($sub_id, 0);
...
class ui_config_subdivision_preview extends ui_config_subdivision_generic {
    ...
    function ui_config_subdivision_preview($sub_id, $cc_id) {
...
class ui_config_favorite extends ui_config {
    ...
    function ui_config_favorite($active_tab) {
