$nc(document).ready(function() {
    ...
    function resize_layout() {
        ...
        var content_height = $nc(window).height() - $nc('.nc-navbar').height() - $nc('.header_block').height() - 6;
...
urlDispatcher.route = {
   ...
   */
    ...
    // Добавление макета
    'template.add': ADMIN_PATH+'template/index.php?phase=2&ParentTemplateID=%1',
    'template_fs.add': ADMIN_PATH+'template/index.php?fs=1&phase=2&ParentTemplateID=%1',
   ...
   */
    ...
    // Переадресации
    'redirect.settings': ADMIN_PATH + 'redirect.php',
    'redirect.add': ADMIN_PATH + 'redirect.php?phase=1',
    'redirect.edit': ADMIN_PATH + 'redirect.php?phase=1&RedirectID=%1',
...
urlDispatcher.addRoutes( {
    'module.banner.setup': NETCAT_PATH+'modules/banner/setup.php',
...
mainView = {
    ...
    setHeader: function(headerText, subheaderText) {
        ...
        document.getElementById('mainViewHeader').innerHTML = "<h1>" + headerText + subheaderText + "</h1>";
