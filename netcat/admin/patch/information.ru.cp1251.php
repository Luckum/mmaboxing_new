...
.</p>
    ...
    <? if ( ! $php_as_cgi): ?>
        ...
        <p>На папки <code class='nc-code'><?= nc_core('HTTP_ROOT_PATH') ?>tmp/</code>, <code class='nc-code'><?= nc_core('HTTP_DUMP_PATH') ?></code>, <code class='nc-code'><?= nc_core('HTTP_FILES_PATH') ?></code>, <code class='nc-code'><?= nc_core('HTTP_TRASH_PATH') ?></code>, <code class='nc-code'><?= nc_core('HTTP_TEMPLATE_PATH') ?></code> следует оставить права – <b>0777</b>.</p>
...
chmod -R 0777 .<?= nc_core('HTTP_ROOT_PATH') ?>tmp/ .<?= nc_core('HTTP_DUMP_PATH') ?> .<?= nc_core('HTTP_FILES_PATH') ?> .<?= nc_core('HTTP_TRASH_PATH') ?> .<?= nc_core('HTTP_TEMPLATE_PATH') ?>
