...
<?php
	$action_map = array(
		...
		array(1, CONTROL_CLASS_ACTIONS_ADD, 'file-add nc--hovered', 'IsAdd'),
		array(2, CONTROL_CLASS_ACTIONS_EDIT, 'edit nc--hovered', 'IsEdit'),
		array(5, CONTROL_CLASS_ACTIONS_DELETE, 'remove nc--hovered', 'IsDelete'),
		array(3, CONTROL_CLASS_ACTIONS_SEARCH, 'mod-search nc--hovered', 'IsSearch'),
		array(4, CONTROL_CLASS_ACTIONS_MAIL, 'mod-comments nc--hovered', 'IsSubscribe')
	);
?>
    ...
    function ClassInformation($ClassID, $action, $phase) {
        ...
        ?>
            <div id='maininfoOn'>
                ...
                ?>
                <script type="text/javascript">
                    classGroup = "<?=md5($Array->Class_Group)?>";
                </script>
            </div>
            <?
