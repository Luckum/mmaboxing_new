...
<?php 
if($_POST['submit']) { 
$title = 'Сообщение об ошибке на сайте MMABOXING.RU';
...
$comment =  substr(htmlspecialchars(trim($_POST['comment'])), 0, 100000);
                ...
                ';
$to = 'luckum@gmail.com';
$mymail='info@mmaboxing.ru';
$from = "From: =?UTF-8?B?". base64_encode("mmaboxing.ru"). "?= < $mymail >\n";
$from .= "X-Sender: < $mymail >\n";
$from .= "Content-Type: text/html; charset=UTF-8\n";
               
mail($to, $title, $mess, $from);
echo '<div class="mclose"><a href="javascript:void(0)" onclick="hide()" title="Закрыть">&times;</a></div><br><br><br><center>Спасибо!<br>Ваше сообщение отправлено.<br><br><br><input onclick="hide()" type="button" value="Закрыть окно" id="close" name="close"><center>'; 
exit();
}  
?>
