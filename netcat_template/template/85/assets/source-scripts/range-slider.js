...
(function( $ ){
	...
	$.fn['noUiSlider'] = function( options, rebuild ){
		...
		,clsList = [
		/*  0 */  'tpl-block-rangeslider-base'
		/*  1 */ ,'tpl-block-rangeslider-origin'
		/*  2 */ ,'tpl-block-rangeslider-handle'
		/*  3 */ ,'tpl-block-rangeslider-input'
		/*  4 */ ,'tpl-block-rangeslider-active'
		/*  5 */ ,'tpl-block-rangeslider-state-tap'
		/*  6 */ ,'tpl-block-rangeslider-target'
		/*  7 */ ,'-lower'
		/*  8 */ ,'-upper'
		/*  9 */ ,'tpl-block-rangeslider-connect'
		/* 10 */ ,'tpl-block-rangeslider-horizontal'
		/* 11 */ ,'tpl-block-rangeslider-vertical'
		/* 12 */ ,'tpl-block-rangeslider-background'
		/* 13 */ ,'tpl-block-rangeslider-stacking'
		/* 14 */ ,'tpl-block-rangeslider-block'
		/* 15 */ ,'tpl-block-rangeslider-state-blocked'
		/* 16 */ ,'tpl-block-rangeslider-ltr'
		/* 17 */ ,'tpl-block-rangeslider-rtl'
		/* 18 */ ,'tpl-block-rangeslider-dragable'
		/* 19 */ ,'tpl-block-rangeslider-extended'
		/* 20 */ ,'tpl-block-rangeslider-state-drag'
		]
