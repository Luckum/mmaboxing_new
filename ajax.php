...
if ($_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest') {
    ...
    require_once '/netcat/modules/default/function.inc.php';
    ...
    switch ($action) {
        ...
        case "read_also":
            $tags = $_POST['tags'];
            $mesId = $_POST['id'];
            $exclusive = isset($_POST['exclusive']) ? "&exclusive=" . $_POST['exclusive'] : "";
            echo s_list_class(3,1,"&nc_ctpl=2018&recNum=" . $cnt . "&searchTags=" . $tags . "&curID=" . $mesId . "&curPos=" . $start . $exclusive);
        break;
        case "videos":
        ...
        case "load_news_part_2":
            if ($_POST['exclusive_row'] == 0) {
                ...
                if ($_POST['exclusive_row_head'] == 1) {
                    echo s_list_class(3,1,"&recNum=6&nc_ctpl=2024&curPos=11");
                } else {
                    echo s_list_class(3,1,"&recNum=6&nc_ctpl=2024&curPos=11&exclusive_row=" . $_POST['exclusive_row']);
                }
            }
        break;
        case "load_news_part_3":
            if ($_POST['exclusive_row'] == 0) {
                ...
                if ($_POST['exclusive_row_head'] == 1) {
                    echo s_list_class(3,1,"&recNum=6&nc_ctpl=2024&curPos=17");
                } else {
                    echo s_list_class(3,1,"&recNum=6&nc_ctpl=2024&curPos=17&exclusive_row=" . $_POST['exclusive_row']);
                }
            }
        break;
        ...
        case 'fighters':
            ...
            if (!empty($_POST['s_value'])) {
                if (!empty($_POST['s_lang'])) {
                    if ($_POST['s_lang'] == "r") {
                        $plus = "&ar_value=" . $_POST['s_value'];
                    } else {
                        $plus = "&ae_value=" . $_POST['s_value'];
                    }
                }
            }
            echo s_list_class(23,24,"&recNum=" . $cnt . "&nc_ctpl=2052&curPos=" . $start . "&s_type=" . $s_type . $is_mob . $plus);
        break;
